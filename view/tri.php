...
$resultSet=$mysqli->query("SELECT* FROM post ORDER BY $order $sort");
if($resultSet->num_rows >0){
    $sort=='DESC' ? $sort='ASC' :$sort='DESC';
    echo"<table border='2' width='90%'>
    <tr> <th><a href='?order=nom&&sort=$sort'>Nom utilisateur</a></th>
         <th>Contenu</th>
         <th><a href='?order=sujet&&sort=$sort'>Sujet</a></th>";
