        ...
        <div class="mobile_menu_content">
            ...
            <div class="menu-main-menu-container">
                <ul id="mobile_main_menu" class="mobile_main_nav">
                    ...
                    <li class="menu-item menu-item-has-children"><a href="#">Shortcodes</a>
                        <ul class="sub-menu">
                            ...
                            <li class="menu-item"><a href="image-frame-animation.html">Image Animation</a></li>
			...
			?>
                ...
                <?php echo ('<img src= "'. $piece['img_src'] .'" alt="">'); ?>
					<div class="mv-item-infor">
						<h6><a href="ajouterticket.php?nom_piece=<?php echo $piece['nom_piece']; ?>"><?php echo $piece['nom_piece']; ?> <span></span></a></h6>
						<p class="rate"><i class="ion-android-star"></i><span>8.1</span> /10</p>
						<p class="describe"><?php echo $piece['description']; ?></p>
						<p class="run-time"> Run Time: <?php echo $piece['duree']; ?> min         <span>Release: <?php echo $piece['date_creation']; ?></span></p>
						<p>Director: <a href="#"><?php echo $piece['realisateur']; ?></a></p>
						<p>Stars: <a href="#">amine,  iheb </a></p>
					</div>
				</div>
            <?php
				}
