    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Table of abonnement</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                    <div class="breadcrumb-item"><a href="#">tickets</a></div>
                    <div class="breadcrumb-item">Table of abonnement</div>
                </div>
            </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-6"><div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-hover">
                                <thead>
                                <tr>
                                    <th scope="col">>numero abonnement</th>
                                    <th scope="col">nom</th>
                                    <th scope="col">prenom</th>
                                    <th scope="col">adresse</th>
                                    <th scope="col">date naissance</th>
                                    <th scope="col">email</th>
                                    <th scope="col">duree d'abonnement</th>
                                ...
                                <tr>
                                    ...
                                    <?php
				                        foreach($listeabonnement as $abonnement){
                                            $login= $abonnementc->recupererlogin($abonnement['id_login']);
			                        ?>
			                        <tr>
                                        <th scope="row"><?php echo $abonnement['num_a']; ?></th>
				                        ...
				                        <td><?php echo $abonnement['delay_a']; ?></td>
				                        <td><?php echo $abonnement['type_a']; ?></td>
			                        </tr>
			                            <?php
				                            }
			                            ?>
...
</div><h3>Statistiques sur les types des abonnements:</h3>

<div id="piechart"> 
<?php 
$abonnementC = new abonnementC();
$listeC = $abonnementC->statistiques();
 ?>
...
function drawChart() { 
  ...
  <?php
  foreach($listeC as $k){
   echo "["; echo "'";echo $k['type_a'];echo"'";echo",";echo $k['count(*)'];echo"],";}?>
