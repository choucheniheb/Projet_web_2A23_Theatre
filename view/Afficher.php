...
<body class="home page-template-default page page-id-350 woocommerce-no-js ppb_enable">
    ...
    <div>
        <table border="2" width="90%">
            <tr> <th>Sujet</th>
            <th>User</th>
            <th>Numero des postes</th>
    </tr>
    <?php 
    require 'connexion.php';
    $requette="SELECT * from forum";
    ...
    while($rows=mysqli_fetch_assoc($query)){
        ...
        echo"<td><a href='Ajout.php?id=".$id."'> Modifier</a></td>";
        echo"<td><a href='posts.php?nom=".$nom."'> Acceder posts</a></td>";
        echo"</tr>";
