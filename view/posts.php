...
<body class="home page-template-default page page-id-350 woocommerce-no-js ppb_enable">
    ...
    <div id="wrapper" class="hasbg transparent">
        ...
        <div class="container">
            <a href="Ajoutp.php"> 
                <button type="submit">Ajouter </button></a>
    </div>
    <div class="container">
            <a href="tri.php"> 
                <button type="submit">Trier </button></a>
    </div>
    <div class="container">
            <a href="pdff.php"> 
                <button type="submit">Imprimer Pdf</button></a>
    </div>
    ...
    <div>
        <table border="2" width="90%">
            <tr> <th>Nom utilisateur</th>
            <th>Contenu</th>
            <th>Sujet</th>
    </tr>
    <?php 
    require 'connexion.php';
    $requette="SELECT * from post";
    ...
    while($rows=mysqli_fetch_assoc($query)){
        ...
        echo "<tr> ";
        echo "<td>".$rows['nom']."</td>";
        echo"<td>".$rows['contenu']."</td>";
        echo"<td>".$rows['sujet']."</td>";
        echo"<td><a href='deletep.php?id=".$id."'> Supprimer</a></td>";
        echo"<td><a href='Ajoutp.php?id=".$id."'> Modifier</a></td>";
        echo"</tr>";
    ...
    <script src='js/plugins/ui/widget.min.js'></script>
    <script src='js/plugins/ui/accordion.min.js'></script>
    <script src='js/plugins/custom-accordion.js'></script>
