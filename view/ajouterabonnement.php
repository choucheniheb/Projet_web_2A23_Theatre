        ...
        <div class="pricing-plan-container">
            <section class="pricing-plan">
                ...
                <div class="pricing-plan__header">
                    <h1 class="pricing-plan__titile">GOLD</h1>
                    <h2 class="pricing-plan__summary"> enjoy our shows</h2>
                </div>
            <div class="pricing-plan__description">
                <ul class="pricing-pla__list"></ul>
                    <li class="pricing-plan__feature">7 Days of shows </li>
                    <li class="pricing-plan__feature">economic class</li>
                </ul>
            </div> 
            <div class="pricing-plan__left">
                <p class="pricing-plan__cost">100 DT</p>
                <a href="ajouterabonnementgold.php" class="pricing-plan__button">Purchase</a>
            </div>
            </section>
            <section class="pricing-plan pricing-plan--highlighted">
                ...
                <div class="pricing-plan__header">
                    <h1 class="pricing-plan__titile">PLATINUM</h1>
                    <h2 class="pricing-plan__summary">enjoy our shows</h2>
                </div>
            <div class="pricing-plan__description">
                <ul class="pricing-pla__list"></ul>
                    <li class="pricing-plan__feature">30 Days of shows </li>
                    <li class="pricing-plan__feature">first class</li>
                </ul>
            </div> 
            <div class="pricing-plan__left">
                <p class="pricing-plan__cost">200 DT</p>
                <a href="ajouterabonnementplat.php" class="pricing-plan__button">Purchase</a>
            </div>
            </section>
            <section class="pricing-plan">
    
                <div class="pricing-plan__header">
                    <h1 class="pricing-plan__titile">DIAMANT</h1>
                    <h2 class="pricing-plan__summary">enjoy our shows</h2>
                </div>
            <div class="pricing-plan__description">
                <ul class="pricing-pla__list"></ul>
                    <li class="pricing-plan__feature">60 Days of shows </li>
                    <li class="pricing-plan__feature">VIP class</li>
                </ul>
            </div> 
            <div class="pricing-plan__left">
                <p class="pricing-plan__cost">400DT</p>
                <a href="ajouterabonnementdiamant.php" class="pricing-plan__button">Purchase</a>
            </div>
            </section>
        </div>
