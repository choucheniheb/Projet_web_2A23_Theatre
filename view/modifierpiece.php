<?php
   ...
   if (
        ...
        if(in_array($file_extension, $ex_auth)){
            ...
            $pieceC->modifierpiece($piece,$_POST["nom_piece"]);
        }
    }
?>
    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <?php
			if (isset($_POST['nom_piece'])) 
				$piece = $pieceC->recupererpiece($_POST['nom_piece']);	
        ?>
            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item"><a href="#">Pice</a></div>
                                ...
                                <form form action="" method="POST" enctype="multipart/form-data">
                                    <div class="card-header">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nom_piece" id="nom_piece" class="form-control" value="<?php echo $piece['nom_piece']; ?>" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>categorie</label>
                                            <input type="text" name="categorie_piece" id="categorie_piece" class="form-control" value="<?php echo $piece['categorie_piece']; ?>" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>date creation</label>
                                            <input type="date" name="date_creation" id="date_creation" value="<?php echo $piece['date_creation']; ?>" class="form-control">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>realisateur</label>
                                            <input type="text" name="realisateur" id="realisateur" value="<?php echo $piece['realisateur']; ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>date de spectacle</label>
                                            <input type="date" name="date_spectacle" id="date_spectacle" value="<?php echo $piece['date_spectacle']; ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>prix de ticket</label>
                                            <input type="text" name="prix" id="prix" value="<?php echo $piece['prix']; ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>duree de piece</label>
                                            <input type="text" name="duree" id="duree" value="<?php echo $piece['duree']; ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <textarea class="form-control" name="description" id="description" required=""><?php echo $piece['description']; ?></textarea>
                                        </div>
                                        </div>
